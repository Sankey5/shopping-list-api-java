...
public class GroceryItemDAOImpl implements GroceryItemDAO {
    ...
    private static List<GroceryItemImpl> populateGroceryItems() {
        ...
        mockGroceryItems.add(new GroceryItemImpl("Bananas", new BigDecimal("1.0"), "lbs", 1));
        mockGroceryItems.add(new GroceryItemImpl("Ground Beef", new BigDecimal("2.5"), "lbs", 1));
        mockGroceryItems.add(new GroceryItemImpl("Salt", new BigDecimal("2.2"), "tpbs", 1));
